...
public class QuizManager : MonoBehaviour
{
    ...
    private void OnPhraseRecognized(PhraseRecognizedEventArgs args)
    {
        ...
        else if (args.text == "Beta")
            SelectAnswerByLetter("B");
        else if (args.text == "Charlie")
            SelectAnswerByLetter("C");
        else if (args.text == "Delta")
    ...
    void LoadQuestions()
    {
        TextAsset txt = Resources.Load<TextAsset>("questions");

        if (txt == null)
        {
            Debug.LogError("questions.txt not found in Resources folder!");
            return;
        }
